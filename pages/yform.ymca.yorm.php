        ...
        foreach ($t as $table) {
            ...
            foreach ($results as $result) {
                ...
                if ('value' === $result['type_id']) {
                    $className = Yorm::toClassName($result['table_name']);
                    $methodName = Yorm::toCamelCase($result['name']);
                    ...
                    $methodTemplate = Yorm::getTypeTemplate($methodMap[$result['type_name']] ?? $defaultMethod);
